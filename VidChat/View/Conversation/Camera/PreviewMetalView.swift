...
class PreviewMetalView: MTKView {
    ...
    private var blurCIContext: CIContext?
    ...
    func setBlur(enabled: Bool) {
        self.isPaused = enabled ? true : false
        self.enableSetNeedsDisplay = enabled ? false : true
        self.framebufferOnly = enabled ? false : true
    ...
    func draw(in view: MTKView) {
        ...
        if self.blurCIContext == nil {
            self.blurCIContext = CIContext(mtlDevice: device)
        }

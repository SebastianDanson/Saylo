...
class CameraViewController: UIViewController, AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    private func setupUI() {
        ...
        switchCameraButton.centerX(inView: view)
        switchCameraButton.centerY(inView: view, constant: 100)
    ...
    private func configureFrontCamera() -> Bool {
        ...
        guard let frontCamera = AVCaptureDevice.default(.builtInWideAngleCamera, for: .video, position: isFrontFacing ? .front : .back) else {
        ...
        frontCameraVideoDataOutputConnection.isVideoMirrored = isFrontFacing
        ...
        frontCameraVideoPreviewLayerConnection.isVideoMirrored = isFrontFacing

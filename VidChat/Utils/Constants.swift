...
let MESSAGE_HEIGHT = SCREEN_WIDTH * 1.6
...
let MINI_MESSAGE_HEIGHT = IS_SMALL_PHONE ? SCREEN_WIDTH/7 : SCREEN_HEIGHT - MESSAGE_HEIGHT - TOP_PADDING - BOTTOM_PADDING - 12
let MINI_MESSAGE_WIDTH = MINI_MESSAGE_HEIGHT * 0.73

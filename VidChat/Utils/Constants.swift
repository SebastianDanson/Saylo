...
let MESSAGE_HEIGHT = SCREEN_WIDTH * (IS_SMALL_PHONE ?  1.44 : 1.6)
...
let MINI_MESSAGE_HEIGHT = IS_SMALL_PHONE ? SCREEN_WIDTH/3.6 : SCREEN_HEIGHT - MESSAGE_HEIGHT - TOP_PADDING - BOTTOM_PADDING - 12
let MINI_MESSAGE_WIDTH = MINI_MESSAGE_HEIGHT * (IS_SMALL_PHONE ? 0.8 : 0.73)

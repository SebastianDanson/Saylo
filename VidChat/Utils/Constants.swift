...
let CHATS_VIEW_HEIGHT = CGFloat(90) + BOTTOM_PADDING
let CHATS_VIEW_SMALL_HEIGHT = CHATS_VIEW_HEIGHT
let MINI_MESSAGE_HEIGHT = SCREEN_HEIGHT - MESSAGE_HEIGHT - CHATS_VIEW_SMALL_HEIGHT - TOP_PADDING_OFFSET - 18
let MINI_MESSAGE_WIDTH = MINI_MESSAGE_HEIGHT

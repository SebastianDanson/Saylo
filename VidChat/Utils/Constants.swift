...
let CHATS_VIEW_HEIGHT = CGFloat(100) + (IS_SMALL_PHONE ? 12 : BOTTOM_PADDING)
let CHATS_VIEW_SMALL_HEIGHT = CHATS_VIEW_HEIGHT
let MINI_MESSAGE_WIDTH = max(SCREEN_HEIGHT - MESSAGE_HEIGHT - CHATS_VIEW_SMALL_HEIGHT - TOP_PADDING_OFFSET - 12, SCREEN_WIDTH/5 - 10)
